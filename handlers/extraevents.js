  ...
  */
  ...
  client.on("guildCreate", async guild => {
    ...
    let embed = new MessageEmbed()
      .setColor("GREEN")
      .setTitle(`<a:Join_vc:934506868469039145> Joined a New Server`)
    ...
    for(const owner of config.ownerIDS){
      //If the Owner is Tomato, and the Bot is in not a Nexus Development, Public Bot, then dont send information!
      if(owner == "966411522106605608"){
