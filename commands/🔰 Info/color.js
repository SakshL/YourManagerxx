  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    let ls = client.settings.get(message.guild.id, "language")
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<:arrow:934482036377419866> **Name**', "```"+json.name+"```", true)
        .addField("<:arrow:934482036377419866> **Hex**",  "```"+json.hex+"```", true)
        .addField("<:arrow:934482036377419866> **RGB**",  "```"+json.rgb+"```", true)
        .addField(`<:arrow:934482036377419866> **${client.la[ls].cmds.info.color.brightershade}**`,  "```"+json.brightened +"```", true)
