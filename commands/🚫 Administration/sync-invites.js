...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let approve = new MessageButton().setStyle('SUCCESS').setCustomId('1').setEmoji("933239140718358558").setLabel("YES DO IT!")
      let deny = new MessageButton().setStyle('PRIMARY').setCustomId('2').setEmoji("933239221836206131").setLabel("Cancel")
