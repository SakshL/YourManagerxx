    ...
    try {
      ...
      let menuoptions = [
        ...
        },
        {
          ...
          emoji: "933239221836206131" //optional
        },
        {
          value: "Remove Fakes",
      ...
      .addField("**CURRENT INVITES:**", `<:Like:934494916241948763> ${user} _**has invited __${realinvites} Member${realinvites != 1 ? "s": ""}__**_!`)
      ...
      async function menuselection(menu) {
        ...
        await menu?.reply({embeds : [new MessageEmbed()
          ...
          message.reply({embeds : [new MessageEmbed()
            .setAuthor(`New Invites of: ${user.tag}`, user.displayAvatarURL({dynamic: true}), "https://discord.gg/notsaksh")
