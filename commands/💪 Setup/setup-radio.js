...
module.exports = {
    ...
    run: async (client, message, args, cmduser, text, prefix) => {
      ...
      try{
        ...
        //send the message of the searching <a:Playing_Audio:934471480987758632> <a:Playing_Audio:934471480987758632> 
        message.reply(
            new Discord.MessageEmbed()
                .setTitle("<a:Playing_Audio:934471480987758632> Setup Complete for Radio Station:  " + song.title)
                .setColor("#7fafe3")
