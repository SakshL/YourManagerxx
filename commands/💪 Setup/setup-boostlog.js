    ...
    try {
      client.settings.ensure(message.guild.id, {
        boost: {
          ...
          startBoost: "<a:Server_Boosts:867777823468027924> {member} **has boosted us!** <a:Light_Saber_Dancce:934497418387521586>",
      ...
      async function first_layer() {
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor({ name: "Boost-Log", url: "https://discord.gg/notsaksh", iconURL: "https://cdn.discordapp.com/emojis/833402717950836806.gif?size=128&quality=lossless" })
          //.setAuthor('Boost-Log', 'https://cdn.discordapp.com/emojis/833402717950836806.gif?size=128&quality=lossless', 'https://discord.gg/notsaksh')
